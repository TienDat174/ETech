<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/MasterPage.Master" AutoEventWireup="true" CodeBehind="QuanLyChiTietDanhMuc2.aspx.cs" Inherits="ETech.WebApp.ADMIN.QuanLyChiTietDanhMuc2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <div class="tmdm-container">
        ...
        <h3 style="text-align: center; font-size: 30px; font-weight: bold; margin-bottom: 20px">DANH MỤC ĐÃ HỦY</h3>
           <div class="body">
        ...
        <div class="nut">
            ...
            <asp:Button ID="btnXoa"  runat="server" Text="Xóa" Class="btnXoa" OnClick="btnXoa_Click" />
        </div>
           </div>   
       </div>
</asp:Content>
