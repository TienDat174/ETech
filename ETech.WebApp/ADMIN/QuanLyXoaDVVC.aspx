<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/MasterPage.Master" AutoEventWireup="true" CodeBehind="QuanLyXoaDVVC.aspx.cs" Inherits="ETech.WebApp.ADMIN.QuanLyXoaDVVC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="xoansx-container">
        <p class="xoansx-header">Bạn có chắc chắn muốn xóa đơn vị vận chuyển :
                       <asp:Label ID="lblDVVC" runat="server" Text="" CssClass="lblDanhMuc"></asp:Label>  
        </p> 
