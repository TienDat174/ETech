<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/MasterPage.Master" AutoEventWireup="true" CodeBehind="QuanLyDuyetDVVC.aspx.cs" Inherits="ETech.WebApp.ADMIN.QuanLyDuyetDVVC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <h3 style="text-align: center; font-size: 30px; font-weight: bold; margin-bottom: 20px">ĐƠN VỊ VẬN CHUYỂN CHỜ CHUYỆT</h3>
           <div class="body">
        ...
        <div class="nut">
            ...
            <asp:Button ID="btnHuy"  runat="server" Text="Hủy" Class="btnHuy" OnClick="btnHuy_Click"/>
        </div>
           </div>   
       </div>
</asp:Content>
