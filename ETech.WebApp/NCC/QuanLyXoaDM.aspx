<%@ Page Title="" Language="C#" MasterPageFile="~/NCC/MasterPage.Master" AutoEventWireup="true" CodeBehind="QuanLyXoaDM.aspx.cs" Inherits="ETech.WebApp.NCC.QuanLyXoaDM" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="xoansx-container">
        <p class="xoansx-header">Bạn có chắc chắn muốn xóa đơn vị danh mục :
