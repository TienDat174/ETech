<%@ Page Title="" Language="C#" MasterPageFile="~/NCC/MasterPage.Master" AutoEventWireup="true" CodeBehind="TrangXoaKhuyenMai.aspx.cs" Inherits="ETech.WebApp.NCC.TrangXoaKhuyenMai" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="xoansx-container">
        <p class="xoansx-header">Bạn có chắc chắn muốn xóa đơn vị khuyến mãi :
                       <asp:Label ID="lblDM" runat="server" Text="" CssClass="lblDanhMuc"></asp:Label>  
        </p> 
