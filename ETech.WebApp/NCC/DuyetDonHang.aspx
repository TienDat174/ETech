<%@ Page Title="" Language="C#" MasterPageFile="~/NCC/MasterPage.Master" AutoEventWireup="true" CodeBehind="DuyetDonHang.aspx.cs" Inherits="ETech.WebApp.NCC.DuyetDonHang" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <div class="giohang-cover">
        ...
        <div class="btn">
            <asp:Button ID="btnDuyet" runat="server" CssClass="btnDuyet" Text="Duyệt" OnClick="btnDuyet_Click"/>
             <asp:Button ID="btnHuy" runat="server" CssClass="btnHuy" Text="Hủy" OnClick="btnHuy_Click" />
        </div>
    </div>
</asp:Content>
